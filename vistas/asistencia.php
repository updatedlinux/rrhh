...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-logo">
    <a href="#"><b>MOVAO GROUP</b> ASISTENCIA | RRHH</a>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="../admin/files/negocio/movao.jpg" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        <input type="password" class="form-control" name="codigo_persona" id="codigo_persona" placeholder="Escribe aqui tu ID">
  ...
  <div class="help-block text-center">
    Ingresa tu ID de asistencia para registrar Entrada o Salida
  </div>
  <div class="text-center">

  </div>
  <div class="lockscreen-footer text-center">
    <a href="../admin/">Ingresa Aqui al Modulo Administrativo</a>
  </div>
</div>
<!-- /.center -->
